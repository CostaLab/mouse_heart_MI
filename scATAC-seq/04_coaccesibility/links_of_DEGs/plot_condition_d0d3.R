...
dict <- list(
    ...
    "Macrophages" = c("Runx1","Il1b", "Cebpb","S100a8", "S100a9", "Cxcr2", "Rbm47", "Rab37", "Maf", "Mafb", "Irf9", "Irf4"), 
...
for(up_gene in up_genes){
    ...
    df1 <- read.table(glue("../../../MotifMatch/Healthy_{celltype}_mpbs_{tf}.bed"))
    df2 <- read.table(glue("../../../MotifMatch/Day3_{celltype}_mpbs_{tf}.bed"))
    df3 <- read.table(glue("../../../MotifMatch/Day10_{celltype}_mpbs_{tf}.bed"))
    ...
    pdf(glue("condition_{celltype}_{up_gene}.pdf"), height = 8, width = 8)
