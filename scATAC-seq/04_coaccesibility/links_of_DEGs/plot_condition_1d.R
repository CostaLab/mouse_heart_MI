...
#Macrophages
#IRF1, IRF4, IRF5, IRF9, Mafb, MAF #(C-MAF)

gene_to_factor = list("Col1a1"= "RUNX2",
                      "Pdgfra" = "CTCF",
                      "S100a8" = c("CEBPB", "CEBPD"),
                      "S100a9" = c("CEBPB", "CEBPD"))

                      #"S100a8" = c("IRF1", "IRF4", "IRF5", "IRF9", "Mafb", "MAF"), #CTCF CEBPG
                      #"S100a9" = c("IRF1", "IRF4", "IRF5", "IRF9", "Mafb", "MAF"), #CTCF CEBPG
                      #"Cxcr2" = c("IRF1", "IRF4", "IRF5", "IRF9", "Mafb", "MAF"), #CTCF CEBPG
                      #"Cebpb" = c("IRF1", "IRF4", "IRF5", "IRF9", "Mafb", "MAF"), #CTCF CEBPG
...
dict <- list(
    ...
    "Macrophages" = c("S100a8", "S100a9"), #, "Cxcr2", "Cebpb","Rbm47", "Rab37", "Maf", "Mafb", "Irf9", "Irf4"), 
...
for(up_gene in up_genes){
    ...
    for(tf in tfs){
        message("gene:tf  ", up_gene, " ", tf, " ", date())
       ...
       tf_track_all <- GeneRegionTrack(range = df_tf,
                                   genome = "mm10",
                                   name = glue("{tf}"),
                                   shape = "box",
                                   col = "blue",
       ...
       pdf(glue("condition_{celltype}_{up_gene}_{tf}.pdf"), height = 8, width = 8)
       plotTracks(trackList, title.width = 0.5, showTitle = TRUE, 
                  from = minbp, to = maxbp, chromosome = chr, 
                  sizes = c(0.4, 0.1, 0.3, 0.3, 0.3, 0.3, 0.2, 0.05), 
