...
saveRDS(markersGS, file = "./macro/Marker_Genes.Rds")
...
WriteXLS::WriteXLS(markerList,
                   ExcelFileName = "./macro/Marker_Genes.xlsx",
...
saveRDS(markersGS, file = "./macro/Marker_Genes_Harmony.Rds")
...
WriteXLS::WriteXLS(markerList,
                   ExcelFileName = "./macro/Marker_Genes_Harmony.xlsx",
                   SheetNames = names(markerList))
...
saveRDS(markersPeaks, file = "./macro/Marker_Peaks_Harmony.Rds")
