...
rownms_order <- stringr::str_replace(rownames(proj), "^Fibroblasts#", "")

fib_meta_data <- fib_meta_data[rownms_order, ]
...
proj <- addCellColData(ArchRProj = proj,
                       data = fib_meta_data[, 'time.ident'],
                       name = "time.ident",
                       cells = rownames(proj),
                       force = TRUE)

proj <- addCellColData(ArchRProj = proj,
                       data = fib_meta_data[, 'gender.ident'],
                       name = "gender.ident",
                       cells = rownames(proj),
                       force = TRUE)
